        ...
        <div className="flex h-screen w-screen bg-background text-foreground overflow-hidden font-sans selection:bg-primary/20">
            ...
            <aside className="w-64 flex flex-col p-4 relative z-20 glass-panel border-r-border border-l-0 border-y-0 transition-colors duration-300">
                <div className="mb-10 flex items-center gap-3 px-2 pt-2">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-blue-600 shadow-[0_0_20px_rgba(37,99,235,0.3)] flex items-center justify-center relative overflow-hidden group">
                ...
                <Button
                    ...
                    className={cn(
                        "flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 mt-auto border border-transparent shadow-sm w-full justification-start h-auto",
                        showLogs
