    ...
    return (
        <div className="space-y-4">
            <div className="space-y-3">
                <div className="flex justify-between"><Label className="text-xs text-muted-foreground uppercase">{t("Workers")}</Label><span className="text-[10px] opacity-70 text-foreground">{config.workers}</span></div>
            ...
            <div className="space-y-3">
                <div className="flex justify-between"><Label className="text-xs text-muted-foreground uppercase">{t("Timeout")}</Label><span className="text-[10px] opacity-70 text-foreground">{config.timeout}s</span></div>
